<!--
  README for github.com/BhargavMakina/BhargavMakina
-->
...
<div align="center">
  ...
  <h2>
    <img src="https://media.giphy.com/media/dzaUX7CAG0Ihi/giphy.gif" width="36" alt="dev" />
    &nbsp;Hey, I am Bhargav&nbsp;
...
Senior Frontend Developer at **Data Economy**, Hyderabad — building enterprise-grade data analytics & governance platforms in React. 4+ years across UI architecture, micro-frontends, full-stack, and cloud.

```yaml
role:        Senior Frontend Developer
focus:       React · Micro Frontends · Data Visualization
backend:     Node.js · Express · REST APIs
cloud:       AWS · Docker · Azure DevOps
currently:   Scaling enterprise UI systems
...
|---|---|---|
| **Knode 2.0** — Enterprise Data Analytics | `React` · `Keylines` · `DataGrid` | API-driven UI · global Data Grid · graph visualizations |
| **Astro** — Backend Integration Platform | `Node.js` · `Express` · `MongoDB` · `Docker` · `AWS` | REST microservices · containerized deploys · AWS infra |
| **Concourse** — Data Compliance Portal | `React` · `Micro Frontends` · `REST APIs` | Reusable component library · MFE domain isolation |

## 📊 GitHub

<div align="center">

  <img src="https://github-readme-stats-eight-theta.vercel.app/api?username=BhargavMakina&theme=tokyonight&show_icons=true&hide_border=true&count_private=true&include_all_commits=true&rank_icon=github&cache_seconds=1800" alt="GitHub Stats" width="48%" />
...
- Scalable UI systems & design systems
- Cloud-native frontends
...
<div align="center">
  <a href="https://www.linkedin.com/in/bhargav-makina/" target="_blank"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=flat-square&logo=linkedin&logoColor=white" alt="LinkedIn" /></a>
  <a href="mailto:vmakina@dataeconomy.ai"><img src="https://img.shields.io/badge/Email-EA4335?style=flat-square&logo=gmail&logoColor=white" alt="Email" /></a>
  <a href="http://bmakina-portfolio-site.s3-website-us-east-1.amazonaws.com/" target="_blank"><img src="https://img.shields.io/badge/Portfolio-0d1117?style=flat-square&logo=vercel&logoColor=white" alt="Portfolio" /></a>
  <a href="https://github.com/BhargavMakina" target="_blank"><img src="https://img.shields.io/badge/GitHub-0d1117?style=flat-square&logo=github&logoColor=white" alt="GitHub" /></a>
</div>
